...
/**
 * Reporte de los roles y usuarios asignados
 * <br><br>
 ...
 * */
public class PDFReportRole extends AbstractPDFOutput
{
    ...
    Paragraph getGroupMaster(Recordset master) throws Throwable
	{
		...
		text = text + "Rol: " + master.getString("rolename") + "\n" + "Descripción: " + master.getString("description");
