        ...
        if (columnas == 13)
        {
            ...
            for(int i = 1; i<numOfRows;i++)
            {
                try
                {
                    ...
                    rs.setValue("sector_empresarial", getSectorEmpresarial(getIdEmpresa()));
                    rs.setValue("empresa", getNombreEmpresa(getIdEmpresa()));
...
////////////////////////////////////////////////////////
    ...
    String getIdEmpresa() throws Throwable{
    	String sql = "select id_empresa from ajvieira_isurvey_security.s_user " +
    			"where userlogin = '" + this.getUserName() + "'";
    	Recordset rs = this.getDb().get(sql);
    	rs.first();
