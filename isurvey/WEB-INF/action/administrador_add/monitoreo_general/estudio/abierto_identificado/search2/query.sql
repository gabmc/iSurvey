...
and upper(sector_empresa) not in (upper('banca y seguros'), upper('comercio y retail'), upper('construccion e ingenieria'), upper('consumo masivo'), upper('energia'), upper('entretenimiento / medios / publicidad'), upper('farmaceutico y salud'), upper('industrial / manufactura'), upper('logistica y transporte'), upper('servicios profesionales y consultoria'), upper('tecnologia y telecomunicaciones'))
