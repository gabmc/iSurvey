select participante.id_participante, nombre_participante, apellido_participante, email_participante, empresa, int_participante_instrumento.estatus, int_participante_instrumento.porcentaje_completado, int_participante_instrumento.token_participante, id_instrumento
